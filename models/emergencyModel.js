...
exports.createCampaign = (data, cb) => {
  db.query('INSERT INTO Emergency_Campaigns (title, description, required_amount) VALUES (?, ?, ?)', data, cb);
};
...
exports.getById = (id, cb) => {
  db.query('SELECT * FROM Emergency_Campaigns WHERE id = ?', [id], cb);
};



exports.addDonation = (data, cb) => {
  db.query('INSERT INTO Campaign_Donations (campaign_id, user_id, amount, payment_status) VALUES (?, ?, ?, ?)', data, cb);
};
